...
var data_function = function data_function(doughnut_element) {
    return {
        labels: ['steps', 'distance', 'calories', 'minutes very actives', 'activity calories', 'floors'],
        datasets: [{
            label: 'steps',
            data: [doughnut_element.first(3).to_a],
...
/******/ });
//# sourceMappingURL=chart1-8c5d77da492d1bfd1235.js.map